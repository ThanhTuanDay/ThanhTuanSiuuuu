...
function displayProducts(products) {
    ...
    products.forEach(product => {
        ...
        row.innerHTML = `
            ...
            <td><button class="edit-button" onclick="editProduct('${product.id}')">Sửa</button>
            <button class="edit-button" onclick="deleteProduct('${product.id}')">Xóa</button></td>
        `;
...
function editProduct(productId) {
    window.location.href = `edit_box.html?productId=${productId}`;
}
